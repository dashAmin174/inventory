...
urlpatterns = [
    ...
    path("materials/<inventory>/<code>/<color>", add_materials_cardex, name = "materials_cardex"),
    ...
    path("products/<inventory>/<code>/<color>", add_products_cardex, name = "products_cardex"),
